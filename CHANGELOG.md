...
- Move the logic for the `entry` macro into [`entry.rs`
  ](https://github.com/speelbarrow/weensy.rs/blob/main/proc-macro/src/entry.rs#L12), replace with a stub in [`lib.rs`
  ](https://github.com/speelbarrow/weensy.rs/blob/main/proc-macro/src/lib.rs#L45)
- Clean up [doctests for the `entry` macro
  ](https://github.com/speelbarrow/weensy.rs/blob/main/proc-macro/src/lib.rs#L10)
